...
-(void)buyOrSellAction{
    ...
    if (![CAUser currentUser].is_agent) {
        [CAAlertView showAlertWithTitle:CALanguages(@"请先完善信息") message:@"" completionBlock:^(NSUInteger buttonIndex, CAAlertView * _Nonnull alertView) {
            if (buttonIndex==1) {
