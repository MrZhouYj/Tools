...
@interface CAAgreementViewController ()
...
@implementation CAAgreementViewController
...
-(void)loadData{
    ...
    [SVProgressHUD show];
    [CANetworkHelper GET:CAAPI_MINE_GET_PROTOCOL_CONTENT parameters:nil success:^(id responseObject) {
...
-(void)agreeClick{
    ...
    CAAgentViewController * agent = [CAAgentViewController new];
