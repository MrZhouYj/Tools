...
@interface CAMenuView()<UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate>
{
    CGPoint          _refPoint;
    UIView          *_refView;
    CGFloat          _menuWidth;
...
+ (instancetype)menuWithActions:(NSArray<CAMenuAction *> *)actions width:(CGFloat)width atPoint:(CGPoint)point{
    ...
    CAMenuView *menu = [[CAMenuView alloc] initWithActions:actions width:width atPoint:point];
    return menu;
}
+ (instancetype)menuWithActions:(NSArray<CAMenuAction *> *)actions width:(CGFloat)width relyonView:(id)view{
    ...
    CAMenuView *menu = [[CAMenuView alloc] initWithActions:actions width:width relyonView:view];
    return menu;
}
