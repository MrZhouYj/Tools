...
-(void)setRightText:(NSString *)rightText{
    ...
    if (!rightText  || [rightText isKindOfClass:[NSNull class]] || !rightText.length) {
        rightText = @"";
    }
...
-(void)singleBigTitle:(NSString *)title{
    ...
    if (!title  || [title isKindOfClass:[NSNull class]] || !title.length) {
        title = @"";
    }
...
-(void)showBriefIntroduct:(NSString *)text{
    ...
    self.rightLabel.attributedText = [TABeginsHappy attributedStringWithHTMLString:text];
