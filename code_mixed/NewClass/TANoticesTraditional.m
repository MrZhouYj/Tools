...
#import "TAPastedFamous.h"
#import "TAWindowsParties.h"

@interface TANoticesTraditional()<UIScrollViewDelegate>
{
    NSInteger pages;
}
@property (nonatomic, strong) UIScrollView * scrollView;
@property (nonatomic, strong) UIView * contentView;
@property (nonatomic, strong) TAWindowsParties * indicatorView;

@property (nonatomic, strong) NSMutableArray * items;

@end

@implementation TANoticesTraditional
...
-(void)setDataArray:(NSArray *)dataArray{
    ...
    if (_dataArray.count==dataArray.count) {
        ...
        NSInteger index = 0;
        for (TAPastedFamous * view in self.items) {
        ...
        for (int i=0; i<dataArray.count; i++) {
            ...
            TAPastedFamous * view = [TAPastedFamous new];
...
-(TAWindowsParties *)indicatorView{
    if (!_indicatorView) {
        _indicatorView = [TAWindowsParties new];
