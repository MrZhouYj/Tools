...
@property (nonatomic, strong) TARisingThere * textView;
...
-(void)initSubViews{
    ...
    self.textView = [TARisingThere new];
...
-(void)sendClick{
    ...
    [SVProgressHUD show];
    [TACrimeStudy uploadImagesWithURL:CAAPI_OTC_CREATE_DISPUTE parameters:para name:@[@"image1",@"image2",@"image3"] images:self.photos progress:^(NSProgress *progress) {
