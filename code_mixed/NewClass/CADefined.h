...
#define CALanguages(key) [[TAUrbanCooperation bundle] localizedStringForKey:(key) value:nil table:@"Localizable"]

//[TAUrbanCooperation bundle]
...
//全局提示信息
#define Toast(msg)  [[TAStreetsJumps defaultToast] showMessage:msg]
...
#define LocalLanguage [TAUrbanCooperation language]
...
#define Wechat_pay @"wechat_pay"
#define Bank_card_pay @"bank_card_pay"

#define Is_Market_Off @"is_market_off_o"
#define Is_Off @"is_offff"
