...
@interface TABarriersIdentifying ()
...
@implementation TABarriersIdentifying
...
- (IBAction)sendClick:(id)sender {
    ...
    [TACrimeStudy POST:CAAPI_MINE_FEEDBACK  parameters:para success:^(id responseObject) {
