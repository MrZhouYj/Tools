...
@interface TADefendingStressed ()

@property (nonatomic, strong) TAImportanceSmiling * passWordOldInputView;
@property (nonatomic, strong) TAImportanceSmiling * passWordNewInputView;
@property (nonatomic, strong) TATheirOurselves * saveButton;

@end

@implementation TADefendingStressed
...
-(void)initSubViews{
    ...
    self.passWordOldInputView = [TAImportanceSmiling showLoginTypeInputView];
    self.passWordNewInputView = [TAImportanceSmiling showLoginTypeInputView];
    ...
    self.saveButton = [TATheirOurselves buttonWithTitle:@"确认修改"];
...
-(void)sendButtonClick{
    ...
    [SVProgressHUD show];
    [TACrimeStudy POST:CAAPI_MEMBERS_UPDATE_PASSWORD parameters:para success:^(id responseObject) {
