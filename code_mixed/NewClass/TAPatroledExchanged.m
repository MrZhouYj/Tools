...
@interface TAPatroledExchanged()
<UINavigationControllerDelegate,
UIImagePickerControllerDelegate>

@property (nonatomic,copy) TAPatroledExchangedBlock photoBlock;   //-> 回掉
...
@implementation TAPatroledExchanged

+(instancetype)shareImgaePicker{
    static dispatch_once_t onceToken;
    static TAPatroledExchanged * picker = nil;
    dispatch_once(&onceToken, ^{
        picker = [TAPatroledExchanged new];
    });
    return picker;
}
...
- (NSInteger)AVAuthorizationStatusIsGranted  {
    ...
    __block TAPatroledExchanged * weakSelf = self;
