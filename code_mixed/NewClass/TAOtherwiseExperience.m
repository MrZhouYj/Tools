...
@implementation TAOtherwiseExperience
...
-(UIView*)creatView:(NSString*)title image:(NSString*)image tag:(NSInteger)tag{
    ...
    textLabel.dk_textColorPicker = DKColorPickerWithKey(NormalBlackColor);
    ...
    switch (tap.view.tag) {
        ...
        case 3:
            if (self.is_transferable) {
                 [self routerEventWithName:@"pushViewController" userInfo:@"TAChancesRemarks"];
            }
            break;
