...
#import "TAPatiosBrightest.h"
#import <WebKit/WKWebView.h>
#import <WebKit/WebKit.h>

@interface TAPatiosBrightest ()
...
@implementation TAPatiosBrightest
...
-(void)loadData{
   ...
   if ([self.webUrl containsString:@"?"]) {
       self.webUrl = [self.webUrl stringByAppendingFormat:@"&lang=%@",[TAUrbanCooperation language]];
   }else{
       self.webUrl = [self.webUrl stringByAppendingFormat:@"?lang=%@",[TAUrbanCooperation language]];
   }
