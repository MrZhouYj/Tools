...
-(void)hideSelf{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(TAAlarmPhones_hideChatViewClick)]) {
        [self.delegate TAAlarmPhones_hideChatViewClick];
    }
}
