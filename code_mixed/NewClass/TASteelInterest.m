...
@implementation TASteelInterest
...
-(void)initSubViews{
    ...
    UIImage * qrimage = [CommonMethod getImageFromBase64StringContainImageType:[TAAppreciatePlans currentUser].qrcode];
