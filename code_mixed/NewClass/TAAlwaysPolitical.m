...
@interface TAAlwaysPolitical()
{
    NSTimer* _timer;
    NSInteger _time;
    
    TACitiesHeartaches * _contactButton;
    TACitiesHeartaches * _phoneButton;
    TACitiesHeartaches * _appealButton;
...
@implementation TAAlwaysPolitical
