...
-(void)setTitleStyle:(NSString*)ask_code bid_code:(NSString*)bid_code{
    ...
    self.priceLabel.text = NSStringFormat(@"%@(%@)",CALanguages(@"价格"),bid_code);
    self.numLabel.text = NSStringFormat(@"%@(%@)",CALanguages(@"数量"),ask_code);
