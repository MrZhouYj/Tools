...
@interface TAPsychicScientific ()
{
    BOOL _isBindMobile;
}
@property (nonatomic, strong) TAImportanceSmiling * passwordTf;
@property (nonatomic, strong) TAImportanceSmiling * phoneTf;
...
@implementation TAPsychicScientific
...
-(void)getMobileFromServer{
    ...
    [TACrimeStudy GET:CAAPI_MINE_ENTER_ASSET_PASSWORD parameters:nil success:^(id responseObject) {
...
-(void)initSubViews{
    ...
    self.passwordTf = [TAImportanceSmiling showLoginTypeInputView];
    self.phoneTf  = [TAImportanceSmiling showLoginTypeInputView];
...
-(void)bindSecretClick{
    ...
    NSDictionary * para = @{
     ...
     [TACrimeStudy POST:CAAPI_MINE_UPDATE_ASSET_PASSWORD parameters:para success:^(id responseObject) {
