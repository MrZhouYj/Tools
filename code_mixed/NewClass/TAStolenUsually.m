...
@implementation TAStolenUsually
...
-(void)initTableView{
    ...
    [self.tableView registerClass:[TABusinessActual class] forCellReuseIdentifier:NSStringFromClass([TABusinessActual class])];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.user.is_identified_success) {
        ...
        TABusinessActual * cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([TABusinessActual class])];
