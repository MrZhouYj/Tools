...
@interface TACitiesHeartaches()

@property (nonatomic, strong) UIView * redDotView;

@end

@implementation TACitiesHeartaches
...
-(void)layoutWithImageSize:(CGSize)size space:(CGFloat)space style:(TACitiesHeartachesStyle)style{
   ...
   switch (style) {
       case TACitiesHeartachesStyleTop:
       {
          ...
          break;
       case TACitiesHeartachesStyleBottom:
           {
               
           }
               break;
         case TACitiesHeartachesStyleLeft:
         {
             [self.imageView mas_makeConstraints:^(MASConstraintMaker *make) {
         ...
         case TACitiesHeartachesStyleRight:
         {
