...
@interface TAThreatenedSuccessful()
{
    TACitiesHeartaches * transferButton;
}
...
@implementation TAThreatenedSuccessful
...
-(void)initSubViews{
    ...
    transferButton = [TACitiesHeartaches new];
    ...
    [transferButton layoutWithImageSize:CGSizeMake(20, 20) space:5 style:TACitiesHeartachesStyleTop];
