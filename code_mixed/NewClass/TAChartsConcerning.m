...
@implementation TAChartsConcerning
...
-(void)initSubviews{
    ...
    self.rightPriceLabel.dk_textColorPicker = DKColorPickerWithKey(SmallGrayTextColor);
...
-(void)setCountryModel:(TATriedWiden *)countryModel{
