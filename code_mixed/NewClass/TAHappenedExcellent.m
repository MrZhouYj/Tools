...
#import "TAHappenedExcellent.h"
#import "TAImportanceSmiling.h"
#import "TAComesSmiling.h"

@interface TAHappenedExcellent ()
...
@implementation TAHappenedExcellent
...
-(void)getMobileFromServer{
    ...
    [TACrimeStudy GET:CAAPI_MINE_GET_BIND_MOBILE parameters:nil success:^(id responseObject) {
...
-(void)initSubViews{
    ...
    self.phoneTf.contentType = TAImportanceSmilingContentPhoneType;
...
-(void)saveAction{
    ...
    [SVProgressHUD show];
    [TACrimeStudy POST:CAAPI_MINE_BIND_MOBILE parameters:para success:^(id responseObject) {
        [SVProgressHUD dismiss];
