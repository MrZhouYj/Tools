...
@protocol TALargeThereDelegata <NSObject>
...
@interface TALargeThere : UIView

@property (nonatomic, weak) id<TALargeThereDelegata> delegata;

@property (nonatomic, assign) TradingType tradeType;

@property (nonatomic, assign) BOOL isFirstSetPriceStr;

@property (nonatomic, assign) BOOL is_off;
...
@property (nonatomic, copy) NSString * number_of_units;

@property (nonatomic, copy) NSString * bid_fee;
