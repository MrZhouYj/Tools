...
@implementation TATranquilXinhua

+(instancetype)shareVerificationCode{
    static dispatch_once_t onceToken;
    static TATranquilXinhua * code;
    dispatch_once(&onceToken, ^{
        code = [TATranquilXinhua new];
    });
    return code;
}
...
//         api_2    进行二次验证的接口 后台接口去验证 app不用进行这个操作
        ...
        NSString * lanuge = [TAUrbanCooperation userLanguage];
