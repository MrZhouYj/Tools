...
-(void)initSubViews{
    ...
    UILabel * leftLabel = [self creatLabel];
    leftLabel.backgroundColor = HexRGB(0x07c3e5);
    ...
    UILabel * rightLabel = [self creatLabel];
    [rightLabel dk_setBackgroundColorPicker:DKColorPickerWithKey(LogoColor)];
