...
@property (nonatomic, strong) TABasedSouthwest *indicatorSegmentView;
...
- (TABasedSouthwest *)indicatorSegmentView
{
    if(!_indicatorSegmentView)
    {
        _indicatorSegmentView = [TABasedSouthwest new];
