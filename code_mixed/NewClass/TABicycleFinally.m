...
#import "TABicycleFinally.h"

@implementation TABicycleFinally
...
-(void)initSubview{
    ...
    self.currencyLabel.dk_textColorPicker = DKColorPickerWithKey(NormalBlackColor);
...
-(void)setModel:(TASymbolRemains *)model{
    _model = model;
