...
@interface TAOurselvesLearning ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TAOurselvesLearning
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [TAUrbanCooperation setUserLanguage:key];
