...
- (void)drawRectAccessory
{
     ...
     */
    if(self.targetLineAccessoryViewStatus != Y_StockChartTargetLineStatusKDJ && self.targetLineAccessoryViewStatus != Y_StockChartTargetLineStatusRSI && self.targetLineAccessoryViewStatus != Y_StockChartTargetLineStatusWR){
        /**
         MACD
         */
...
//        [self.dealLineLayer addSublayer:dealshaLineLayer1];
    ...
    }else if (self.targetLineAccessoryViewStatus == Y_StockChartTargetLineStatusRSI){
        /**
         RSI
         */
        //画RSI_6线
    ...
    } else if (self.targetLineAccessoryViewStatus == Y_StockChartTargetLineStatusKDJ) {
        /**
        KDJ
         */
        //画KDJ_K线
