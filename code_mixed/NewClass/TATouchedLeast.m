...
#import "TAAlwaysMarching.h"

@interface TATouchedLeast()
{
    UILabel * _leftLabel;
...
-(void)initTop{
    ...
    TAAlwaysMarching * lastView = nil;
    for (int i=0; i<20; i++) {
      
        TAAlwaysMarching * view = [[TAAlwaysMarching alloc] init];
    ...
    TAAlwaysMarching * lastViewr = nil;
    for (int i=0; i<20; i++) {
...
-(void)fresh:(NSArray *)buyArr sellArr:(NSArray *)sellArr{
        ...
        for (int i=0; i<20; i++) {
            TAAlwaysMarching * view = self.buyListViewArr[i];
        ...
        for (int i=0; i<20; i++) {
            TAAlwaysMarching * view = self.sellListViewArr[i];
            if (sellArr.count>i) {
