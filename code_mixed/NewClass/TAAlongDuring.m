...
@property (nonatomic, strong) TAImportanceSmiling * phoneInputView;
...
-(void)setLoginType:(NSString *)loginType{
    ...
    if ([_loginType isEqualToString:@"password"]) {
        ...
        self.phoneInputView.contentType = TAImportanceSmilingContentNone;
        ...
        self.phoneInputView.contentType = TAImportanceSmilingContentPhoneType;
...
-(void)gotoRegistController{
    ...
    TAHappinessThemselves * regist = [TAHappinessThemselves new];
...
-(void)initSubViews{
    ...
    self.phoneInputView = [TAImportanceSmiling showLoginTypeInputView];
    ...
    self.saveButton = [TATheirOurselves buttonWithTitle:CALanguages(@"登录")];
...
-(void)forgetPasswordClick{
    ...
    TASearchedFlying * forgetPassword = [TASearchedFlying new];
...
-(void)loginAction:(NSDictionary*)result{
    ...
    [TACrimeStudy POST:CAAPI_MEMBERS_SIGN_IN parameters:para success:^(id responseObject) {
