...
-(void)emptyViewAddClick{
    ...
    if ([TAAppreciatePlans currentUser].is_identified_success) {

        TAPaymentEither * add = [TAPaymentEither new];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TAMaybeSeeking * cell = [tableView dequeueReusableCellWithIdentifier:@"TAMaybeSeeking"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row<keys.count) {
        ...
        TATransformationStudy * addPay = [TATransformationStudy new];
        addPay.payType  = key;
...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"TAMaybeSeeking" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"TAMaybeSeeking"];
        [self addEmptyView];
    }
    return _tableView;
}
...
-(void)addPayMenthodButton{
    ...
    self.saveButton = [TATheirOurselves buttonWithTitle:@"新建"];
