...
@interface TAMomentsCustoms()

@property (nonatomic, strong) TAPremisesTaking * priceActionView;
...
@property (nonatomic, strong) TAOtherwiseExperience * menuView;

@end

@implementation TAMomentsCustoms
...
-(void)initSubViews{
    ...
    self.priceActionView = [TAPremisesTaking new];
    ...
    TAOtherwiseExperience * menuView = [TAOtherwiseExperience new];
