...
-(void)setOriginDictionary:(NSDictionary *)originDictionary{
    ...
    self.titleLabel.text = NSStringFormat(@"%@%@",CALanguages([trade_type isEqualToString:@"buy"]?@"购买":@"出售"),[originDictionary[@"currency_code"] uppercaseString]);
    ...
    [self.allButton setTitle:CALanguages([trade_type isEqualToString:@"buy"]?@"全部买入":@"全部出售") forState:UIControlStateNormal];
